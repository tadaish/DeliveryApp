    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('order_value', models.DecimalField(decimal_places=2, max_digits=10, null=True, verbose_name='value')),
                ('created_date', models.DateTimeField(auto_now_add=True)),
                ('status', models.SmallIntegerField(choices=[(0, 'Huỷ '), (1, 'Hoàn Thành'), (2, 'Đang Giao')])),
